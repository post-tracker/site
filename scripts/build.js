...
// Minified iframe placeholder src
const iframeHTML = fs.readFileSync( path.join( __dirname, '/../web-assets/iframe-placeholder.html' ), 'utf8' );
const minifiedHTML = minify( iframeHTML, minifyConfig );
const iframePlaceholderBase64 = Buffer.from( minifiedHTML ).toString( 'base64' );
addGameProperty( gameExtraData, 'iframeSrc', iframePlaceholderBase64 );
